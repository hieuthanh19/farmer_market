...
public class CategoryVegetableDetail extends AppCompatActivity {
    private int categoryID;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_category_vegetable_detail);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.activity_category_vegetable_detail, container, false);
        // get views
        RecyclerView recyclerViewProductVertical = view.findViewById(R.id.category_detail_vegetable);
