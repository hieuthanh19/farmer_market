...
public class Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrOrder.add(new Orders(1, 1, 1, 1, c, c, "20 tran hung dao", 1200, "This is description", 1));
        arrOrder.add(new Orders(2, 2, 2, 2, c, c, "aaaaadao", 120210, "This is description", 1));
        arrOrder.add(new Orders(3, 3, 3, 3, c, c, "nvncbnng dao", 203210, "This is description", 1));
